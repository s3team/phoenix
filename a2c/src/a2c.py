...
if __name__ == "__main__":
    ...
    p.add_argument('-o', '--output', help='specify the name of output C file', default='output.c')
    p.add_argument('-v', '--version', action='version', version='0.5')
    ...
    print("to compile, run: gcc {} {}".format(c_flags,output_file))
