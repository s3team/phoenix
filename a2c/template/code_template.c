...
int main(int argc, char * argv[]){
    ...
    unsigned char * stack;
#ifdef __x64__
    stack = (char*)malloc(__STACK_SIZE__ * 2);
    rsp = rbp = (int)stack + __STACK_SIZE__ * 2 - 32;
#else
    stack = (char*)malloc(__STACK_SIZE__);
    esp = ebp = (int)stack + __STACK_SIZE__ - 16;
#endif
